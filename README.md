...
- `sql/01_create_mock_data.sql` — создание таблицы `mock_data`
...
Если нужно запустить автоматическую загрузку заново, удалите том данных и поднимите контейнер ещё раз:
